    ...
    <div className="min-h-screen bg-[#fcfdfc] flex font-sans">
      ...
      <div className="lg:ml-64 flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 px-8 py-6">
          <div className="mb-6">
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight font-outfit">Bookmarks</h1>
            <p className="text-xs text-gray-500">Quickly access papers and documents you have saved.</p>
          </div>
          ...
          <div className="border border-dashed border-gray-200 rounded-3xl p-12 text-center max-w-xl mx-auto my-12 bg-white flex flex-col items-center">
            ...
            <h3 className="text-sm font-bold text-gray-800">Your bookmarks list is empty</h3>
            <p className="text-xs text-gray-400 mt-1 mb-4">Bookmark cards inside past papers and dashboards to save them here.</p>
          </div>
        </main>
